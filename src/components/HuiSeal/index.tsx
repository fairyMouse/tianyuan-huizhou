...
export const HuiSeal: FC<HuiSealProps> = ({ className = "", size = "md" }) => {
  ...
  return (
    ...
    >
      <Text className={`font-serif ${textSize} leading-tight text-cinnabar`}>田园</Text>
      <Text className={`font-serif ${textSize} leading-tight text-cinnabar`}>徽州</Text>
    </View>
  )
}
